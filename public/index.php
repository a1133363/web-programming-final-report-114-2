...
$routes = [
    'GET' => [
        ...
        'buyer-profile' => [BuyerController::class, 'profileForm'],
    ...
    'POST' => [
        ...
        'buyer-profile-update' => [BuyerController::class, 'updateProfile'],
        'buyer-password-update' => [BuyerController::class, 'updatePassword'],
        'buyer-delete-account' => [BuyerController::class, 'deleteAccount'],
