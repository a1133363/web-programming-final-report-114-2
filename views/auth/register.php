<section class="auth-shell">
    <div class="auth-aside register-aside">
        ...
        <dl class="auth-points"><div><dt>80</dt><dd>初始信用</dd></div><div><dt>2</dt><dd>可選角色</dd></div><div><dt>∞</dt><dd>虛構物件</dd></div></dl>
    </div>
    <div class="auth-card">
        ...
        <form method="post" action="<?= e(url('register')) ?>" class="stack-form">
            ...
            <fieldset class="role-choice"><legend>主要角色</legend>
                <label><input type="radio" name="role" value="buyer" checked><span><strong>買家</strong><small>出價、收藏、付款與評價</small></span></label>
                <label><input type="radio" name="role" value="seller"><span><strong>賣家</strong><small>刊登、交付與銷售報表</small></span></label>
            </fieldset>
