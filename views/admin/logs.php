<section class="admin-shell">
    <aside class="admin-sidebar">
        ...
        <nav aria-label="後台功能"><a href="<?= e(url('admin')) ?>">總覽</a><a href="<?= e(url('admin')) ?>#reviews">商品審核</a><a href="<?= e(url('admin')) ?>#reports">報表中心</a><a href="<?= e(url('admin-disputes')) ?>">爭議處理</a><a class="active" href="<?= e(url('admin-logs')) ?>">操作紀錄</a></nav>
